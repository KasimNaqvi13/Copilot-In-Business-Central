page 50100 "Draft Project"
{
    ...
    begin
        ...
        exit(Format('3MUIo1xc8Gkjd05I0Fg2KGhjBtK14Rkqrg8OAFbGtQoKONBohw7hJQQJ99BBACYeBjFXJ3w3AAABACOGVTg5'));
    ...
    begin
        ...
        exit('https://bccopilottesting.openai.azure.com/');
    end;
